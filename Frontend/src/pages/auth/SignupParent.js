        ...
        <div className="bg-white/95 backdrop-blur-lg rounded-[32px] shadow-2xl p-6 md:p-8 border-2 border-white/80 relative overflow-hidden">
          ...
          <div className="text-center mb-6 relative">
            ...
            >
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-[#60b5ff] to-[#5ef2d5] rounded-full p-5 shadow-xl">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-5xl font-black mb-2 bg-gradient-to-r from-[#60b5ff] via-[#5ef2d5] to-[#ffe588] bg-clip-text text-transparent"
          ...
          <form onSubmit={handleSubmit} className="space-y-3 mb-5">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-[#60b5ff] to-[#5ef2d5] text-white font-black text-lg rounded-2xl shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 relative overflow-hidden group mt-5"
              style={{ fontFamily: 'Comic Sans MS, cursive' }}
            >
              {loading ? (
                <>
          ...
          >
            <Link
              to="/role-selector"
              className="inline-flex items-center gap-2 text-gray-600 font-semibold hover:text-[#60b5ff] transition-colors"
            >
